<template>
  <view class="truster-detail-page">
        ...
        <view class="card-header">
          ...
          <view class="info">
            ...
            <view class="location-row">
              ...
              <text class="distance" v-if="distance">距离 {{ distance }}</text>
            </view>
          </view>
        </view>
        <view class="bio" v-if="trusteeInfo.bio">
          <text>{{ trusteeInfo.bio }}</text>
        </view>
        <view class="bio" v-else>
          <text>这个人很懒，还没有填写自我介绍~</text>
        </view>
      </view>

      <!-- 3. 认证状态 -->
      <view class="status-card" v-if="trusteeInfo.status">
    ...
    <!-- 5. 底部操作栏 -->
    <view class="action-bar" v-if="trusteeInfo">
      <!-- 编辑按钮（仅本人可见） -->
